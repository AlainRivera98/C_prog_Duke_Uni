...
void encrypt(FILE * f, int key, FILE * outfile){
  ...
  //must free the malloc/realloc line that
  //getline used, cus it's no longer needed
  free(line);
}
